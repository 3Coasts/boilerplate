module.exports = {
  ...
  favicon: {
    files: {
      src: './public/favicon.png',                // Path(s) for file to produce the favicons. `string` or `object`
      dest: './public/favicons',               // Path for writing the favicons to. `string`
      html: './lib/index.html',               // Path(s) for HTML file to write or append metadata. `string` or `array`
